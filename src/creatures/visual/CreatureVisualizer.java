...
public class CreatureVisualizer extends Visualizer {
	...
	protected Iterable<IDrawable> getDrawables() {
		ArrayList<IDrawable> creatures = new ArrayList<IDrawable>();
		for(IDrawable d : simulator.getCreatures()) {
			creatures.add(d);
		}
		
		
		creatures.addAll((ArrayList<EnergyPoint>)simulator.getEnergyPoints());
		return creatures;
	}
